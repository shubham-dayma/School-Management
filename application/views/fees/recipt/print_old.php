          ...
          <div class="box box-danger">
			 ...
			 <?php if (!empty($base_details)) { ?>
				 <div class="row" id="printcontent" style="padding:10px;" >
					<div class="col-md-12">
						<p class="serialno" style="position: absolute;right: 5%;"><?php echo lang('recipt_no') ?> 
						...
						<div>
							<p><?php echo lang('father').' '.lang('name').' : '.ucwords($base_details->f_name.' '.$base_details->lname) ?></p>
							<p align="right"><?php echo lang('date').' : '.$base_details->recipt_date?></p>
						</div>
						<div>
							<?php if(!empty($head_details)|| !empty($fast_bills)) { ?>
							<table cellpadding="5" cellspacing="1" border="1px">
								<thead>
									<tr>
						...
						<div>
							<label><?php echo lang('excess_recieved') ?></label>
						...
						<div>
							<label><?php echo lang('excess_return') ?></label>
						...
						<div>
							<label><?php echo lang('discount_applied') ?></label>
							<span><?php echo $difference_details->discount ?></span>
						</div>
						<?php } ?>
						<div>
							<label><?php echo lang('total_paid') ?></label>
							<span><?php echo $base_details->total_pay ?></span>
						</div>
						<div>
							<label><?php echo lang('in_words') ?></label>
