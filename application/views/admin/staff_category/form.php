			 ...
			 <?php } ?>
				  <form class="form-horizontal" method="post">
					  <div class="box-body">
					  	<div class="col-md-6">
							<div class="form-group">
							  <label for="name" class="col-sm-4 control-label"><?php echo lang('category').' '.lang('name'); ?></label>
							  <div class="col-sm-8">
					...
					<div class="box-footer">
						<a href="<?php echo site_url ('admin/staff_category'); ?>" class="btn btn-default btn-flat"><?php echo lang('cancel') ?></a>
