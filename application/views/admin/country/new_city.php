				  ...
				  <form class="form-horizontal" method="post">
					  <div class="box-body">						
					  	<div class="col-md-6">
							  ...
							  <label for="name" class="col-sm-4 control-label"><?php echo lang('for').' '.lang('state'); ?></label>
							  <div class="col-sm-8">
					...
					<div class="box-footer">
						<a href="<?php echo site_url ('admin/country/state/'.$row->country_id); ?>" class="btn btn-default btn-flat"><?php echo lang('cancel') ?></a>
