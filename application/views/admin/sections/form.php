					  ...
					  <div class="box-body">
					  	<div class="col-md-6">
    						<div class="form-group"> 
							  <label for="name" class="col-sm-4 control-label"><?php echo lang('class'); ?></label>
							  <div class="col-sm-8">
								<select class="form-control" name="class_id">
									<?php if (!empty ($result)) { foreach ($result as $class) { ?>
										<option value="<?php echo $class->id ?>" <?php echo ($class->id == @$row->class_id) ? 'selected="selected"' :'' ?>><?php echo $class->name ?></option>
									<?php }} ?>
								</select>
							  </div>
							</div>
