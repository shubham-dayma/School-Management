...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo site_url ('assets/common') ?>/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo site_url (); ?>"><b><?php echo $page_title ?></b></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg"><?php echo lang('auth_start_session'); ?></p>
	<?php echo validation_errors(); 
		  echo @$errors;	 
	?>
    <form method="post">
      <div class="form-group has-feedback">
        <input type="email" class="form-control" name="email" placeholder="<?php echo lang('auth_email') ?>">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control" name="password" placeholder="<?php echo lang('auth_password') ?>">
      ...
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label>
              <input type="checkbox"> <?php echo lang('auth_remember_me') ?>
            </label>
          </div>
        </div>
        <!-- /.col -->
        <div class="col-xs-4">
		  <input type="submit" name="submit" class="btn btn-primary btn-block btn-flat" value="<?php echo lang('sign_in'); ?>">
        </div>
        <!-- /.col -->
      </div>
    </form>
...
<!-- iCheck -->
<script src="<?php echo site_url ('assets/common') ?>/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
