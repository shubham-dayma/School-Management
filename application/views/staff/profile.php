...
.iradio_line-yellow { margin-right:10px;} 
...
.select2-container--default .select2-selection--multiple .select2-selection__choice{background-color: #f39c12;}
			 ...
			 <?php } ?>
				  <form class="form-horizontal" enctype="multipart/form-data" method="post">
					...
					<div class="box-footer">
						<a href="<?php echo site_url ('staff/dashboard'); ?>" class="btn btn-default btn-flat"><?php echo lang('cancel') ?></a>
