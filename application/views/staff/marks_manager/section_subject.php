              ...
              <table class="table table-bordered table-striped">
                ...
                <tbody>
					...
					<tr>
					  ...
					  <td>
					  	<a href="<?php echo site_url('staff/marks_manager/co_scolastic_marks/'.$section_detail->id.'/'.$c_subject->id) ?>" class="btn btn-warning btn-flat">
					...
					<tr>
					  ...
					  <td>
					  	<?php $criteria = $this->Marks_zone->get_subject_marks_criteria($this->session->userdata('academic_session'),$class->id,$subject->id,$exam->id); 
							if (!empty($criteria)){
						?>
					  	<a href="<?php echo site_url('staff/marks_manager/enter_marks/'.$section_detail->id.'/'.$subject->id.'/'.$exam->id) ?>" class="btn btn-warning btn-flat">
						<?php echo lang('add_marks') ?>
						</a>
						<?php }else { ?>
		...
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			<div class="row">
				...
				<div class="col-md-6">
					<a href="<?php echo site_url('staff/marks_manager/'.$marksheet->url.'/'.$section_detail->id.'/'.$marksheet->id); ?>" target="_blank">
	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			<div class="row">
			  <div class="col-md-6">
				<a href="<?php echo site_url('staff/marks_manager/tabsheet_1/'.$section_detail->id); ?>" target="_blank">
